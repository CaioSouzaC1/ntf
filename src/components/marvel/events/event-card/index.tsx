...
import { IEventsResult } from "@/interfaces/marvel/events";
...
export default function EventCard({ event }: ICharacterCardProps) {
  return (
      ...
      <Card className="cursor-pointer">
        ...
        <CardContent>
          ...
          <div className="min-h-12 mt-4">
            <CardDescription>
              {MarvelUtils.cutDescription(event.description, 60)}
            </CardDescription>
          </div>
        </CardContent>
        <CardFooter>
